...
export default function App() {
  ...
  const generateSummary = async (submittedForm) => {
    ...
    setSummary("⟳ Generating AI clinical summary...");
    ...
    try {
      ...
      if (!res.ok) {
        setSummary("Error: " + res.status + " - " + await res.text());
      ...
      if (!fullText) setSummary("Summary generated but empty. Please try again.");
    } catch (e) {
      setSummary("Failed: " + e.message + ". Check your connection and try again.");
    }
    setLoadingSummary(false);
  };
